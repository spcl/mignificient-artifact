...
INPUT_DIR = os.path.join(SCRIPT_DIR, os.path.pardir, os.path.pardir, os.path.pardir, 'benchmark-inputs', 'ml-inference', 'resnext-50')
...
def function(obj):
    ...
    if model is None:
        ...
        # torch.save(model, "../../../benchmark-inputs/ml-inference/resnext-50/resnext-50.pt")
        before = timer()
        model = torch.load(os.path.join(INPUT_DIR, 'resnext-50.pt'), weights_only=False)
