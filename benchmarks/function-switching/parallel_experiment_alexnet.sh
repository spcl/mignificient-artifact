...
run_parallel() {
    parallel --tag "python /work/serverless/2024/gpus/mignificient-artifact/benchmark-apps/ml-inference/alexnet/functions.py > $OUTPUT_DIR/run_worker{#}.out 2>&1" ::: {1..2}
}
